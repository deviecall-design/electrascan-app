...
export default function EstimateScreen() {
  ...
  const empty = !loading && liveEstimates.length === 0;
    ...
    <div className="anim-in">
      <PageHeader
        ...
        cta={
          <PrimaryButton icon={<Plus size={15} />} onClick={() => navigate("/estimate/new")}>
            {empty ? "Upload plan" : "New estimate"}
          </PrimaryButton>
        }
      />
      ...
      {loading ? (
        ...
        <EmptyState
          ...
          body="Upload a floor plan, review the takeoff, then send the quote. Saved quotes land here with GST-inclusive totals."
