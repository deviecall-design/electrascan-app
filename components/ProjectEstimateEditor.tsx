...
import {
  quoteFromProjectEstimate,
  buildQuoteText,
  downloadTextFile,
  quoteFileName,
  triggerDownload,
} from "../utils/quoteExport";
...
const ProjectEstimateEditor: React.FC<Props> = ({ projectId, estimateId }) => {
  ...
  const exportQuoteText = () => {
    ...
    const quote = quoteFromProjectEstimate(tenant, project, estimate);
    downloadTextFile(buildQuoteText(quote), quoteFileName(quote.reference, "txt"));
  };
  ...
  return (
    <div style={{ color: C.text }}>
      ...
      >
        ...
        <ToolbarBtn onClick={() => void runQuotePdf("preview")} icon="👁">
          Preview PDF
        </ToolbarBtn>
        <ToolbarBtn onClick={() => void runQuotePdf("download")} icon="📄">
          Download PDF
        </ToolbarBtn>
        <ToolbarBtn onClick={exportQuoteText} icon="📝">
          Export text
        </ToolbarBtn>
